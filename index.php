...
<div id="formular">
    ...
    <form action="GET" id="form">
        <input type="datetime" class="textfields" name="von" placeholder="Von"><br>
        <input type="datetime" class="textfields" name="bis" placeholder="Bis"><br>
        <input type="text" class="textfields" name="beschreibung" placeholder="Beschreibung"><br>
        <input type="text" class="textfields" name="ort" placeholder="Ort"><br>
        Minions:<br>
